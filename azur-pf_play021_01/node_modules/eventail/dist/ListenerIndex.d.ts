 ...
 * @internal
 */
export declare class ListenerIndex {
    ...
    private readonly noContextCallbacks;
    /**
     ...
     * @internal
     */
    constructor(callback?: Function, context?: object | Symbol, priority?: number);
    /**
     ...
     * @internal
     */
    insert(callback: Function, context?: object | Symbol, priority?: number): void;
    /**
     ...
     * @internal
     */
    remove(callback: Function, context?: object | Symbol): void;
    /**
     ...
     * @internal
     */
    has(callback: Function, context?: object | Symbol): boolean;
    /**
     ...
     * @internal
     */
    getPriority(callback: Function, context?: object | Symbol): number | undefined;
}
