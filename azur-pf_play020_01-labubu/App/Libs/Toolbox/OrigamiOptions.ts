...
export class OrigamiPaper {
    ...
    private correctOrder: FoldName[] = ['folds_2', 'folds_4', 'folds_6', 'folds_8'];

    private foldConfig: Record<FoldName, FoldConfig> = {
        folds_2: {
            axis: 'z', sign: -1,
            neighbors: [['folds_3', 'z'], ['folds_9', 'z']]
        },
        folds_4: {
            axis: 'x', sign: 1,
    ...
    private updateOffsets() {
        ...
        this.stack.forEach((name, index) => {
            ...
            gsap.to(mesh.position, {
                ...
                y: original.position.y + (index + 1) * OFFSET_Y,
