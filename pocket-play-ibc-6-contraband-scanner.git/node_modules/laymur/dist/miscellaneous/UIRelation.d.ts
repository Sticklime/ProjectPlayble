 ...
 */
export declare enum UIRelation {
 ...
 */
export declare function convertRelation(relation: UIRelation): Operator;
/**
 ...
 */
export declare function resolveRelation(relation?: UIRelation): UIRelation;
