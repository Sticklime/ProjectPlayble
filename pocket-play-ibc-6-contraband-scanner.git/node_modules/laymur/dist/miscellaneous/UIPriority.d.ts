 ...
 */
export declare enum UIPriority {
 ...
 */
export declare function convertPriority(priority: UIPriority): number;
/**
 ...
 */
export declare function resolvePriority(priority?: UIPriority): UIPriority;
