import { PlaneGeometry, Color, Scene, OrthographicCamera, ShaderMaterial, Vector4, Mesh, Texture, Vector2, Vector3, Matrix2, Matrix3, Matrix4, MathUtils, Quaternion, CanvasTexture, LinearFilter, WebGLRenderTarget, UnsignedByteType, RGBAFormat, PerspectiveCamera, InstancedBufferGeometry, InstancedBufferAttribute } from 'three';
...
class UIColor extends i {
    ...
    copy(color) {
        if (color instanceof UIColor) {
            if (this.rInternal !== color.rInternal &&
...
var UIMicroEvent;
(function (UIMicroEvent) {
    UIMicroEvent[UIMicroEvent["CHANGE"] = 0] = "CHANGE";
})(UIMicroEvent || (UIMicroEvent = {}));
...
class UIMicro extends i {
    ...
    copy(value) {
        if (this._private_xInternal !== value._private_xInternal &&
            this._private_yInternal !== value._private_yInternal &&
            this._private_anchorXInternal !== value._private_anchorXInternal &&
            this._private_anchorYInternal !== value._private_anchorYInternal &&
            this._private_scaleXInternal !== value._private_scaleXInternal &&
            this._private_scaleYInternal !== value._private_scaleYInternal &&
            this._private_rotationInternal !== value._private_rotationInternal &&
            this._private_anchorModeInternal !== value._private_anchorModeInternal) {
            this._private_xInternal = value._private_xInternal;
            this._private_yInternal = value._private_yInternal;
            this._private_anchorXInternal = value._private_anchorXInternal;
            this._private_anchorYInternal = value._private_anchorYInternal;
            this._private_scaleXInternal = value._private_scaleXInternal;
...
var UIAnimatedImageEvent;
(function (UIAnimatedImageEvent) {
    UIAnimatedImageEvent[UIAnimatedImageEvent["PLAY"] = 0] = "PLAY";
    UIAnimatedImageEvent[UIAnimatedImageEvent["PAUSE"] = 1] = "PAUSE";
    UIAnimatedImageEvent[UIAnimatedImageEvent["STOP"] = 2] = "STOP";
})(UIAnimatedImageEvent || (UIAnimatedImageEvent = {}));
/**
 ...
 */
class UIAnimatedImage extends UIElement {
    /**
     ...
     */
    constructor(layer, sequence, options = {}) {
        ...
        this._private_intervalHandler = undefined;
        this._private_currentFrameIndex = 0;
        ...
        this._private_sequenceInternal = tempSequence;
        this._private_colorInternal = color;
        const defaultFrameRate = 24;
        this._private_frameRateInternal = options.frameRate ?? defaultFrameRate;
        this._private_loopInternal = options.loop ?? true;
     ...
     */
    get frameRate() {
        return this._private_frameRateInternal;
    }
    /**
     ...
     */
    get loop() {
        return this._private_loopInternal;
    }
    /**
     ...
     */
    get duration() {
        return this._private_sequenceInternal.length / this._private_frameRateInternal;
    }
    /**
    ...
    set frameRate(value) {
        ...
        const wasPlaying = this._private_intervalHandler !== undefined;
        if (wasPlaying) {
            this.pause();
        }
        this._private_frameRateInternal = value;
        if (wasPlaying) {
            this.play();
        }
    }
     ...
     */
    set loop(value) {
        this._private_loopInternal = value;
    }
    /**
     * Starts or resumes playback of the animation.
     */
    play() {
        if (this._private_intervalHandler !== undefined) {
            return;
        }
        this._private_intervalHandler = setInterval(() => {
            this._private_currentFrameIndex++;
            if (this._private_loopInternal) {
                this._private_currentFrameIndex %= this._private_sequenceInternal.length;
            }
            else if (this._private_currentFrameIndex >= this._private_sequenceInternal.length) {
                this._private_currentFrameIndex = this._private_sequenceInternal.length - 1;
                this.pause();
                return;
            }
            this._private_updateFrame();
        }, 1000 / this._private_frameRateInternal);
    ...
    pause() {
        ...
        clearInterval(this._private_intervalHandler);
        this._private_intervalHandler = undefined;
    ...
    _private_updateFrame() {
        const frame = this._private_sequenceInternal[this._private_currentFrameIndex];
        this.sceneWrapper.setUniform(this.planeHandler, "map", frame.texture);
        this.sceneWrapper.setUniform(this.planeHandler, "uvTransform", frame.uvTransform);
    }
}
 ...
 */
class UIGraphics extends UIElement {
    /**
    ...
    constructor(layer, options = {}) {
        ...
        super(layer, options.x ?? 0, options.y ?? 0, width, height, source$2, {
            map: canvasTexture,
        ...
        this._private_ctx = ctx;
        this._private_canvasTexture = canvasTexture;
        this._private_colorInternal = color;
        this._private_colorInternal.on(UIColorEvent.CHANGE, this._private_onColorChange);
    }
    /**
     ...
     */
    clear(fillColor) {
        this._private_ctx.clearRect(0, 0, this._private_canvas.width, this._private_canvas.height);
        if (fillColor !== undefined) {
            this._private_ctx.fillStyle = fillColor.toCSSColor();
            this._private_ctx.fillRect(0, 0, this._private_canvas.width, this._private_canvas.height);
        }
        this._private_canvasTexture.needsUpdate = true;
        return this;
    }
    /**
    ...
    rect(x, y, width, height) {
        this._private_ctx.rect(x, y, width, height);
        this._private_canvasTexture.needsUpdate = true;
        return this;
    }
    /**
    ...
    fillRect(x, y, width, height) {
        this._private_ctx.fillRect(x, y, width, height);
        this._private_canvasTexture.needsUpdate = true;
        return this;
    }
    /**
    ...
    strokeRect(x, y, width, height) {
        this._private_ctx.strokeRect(x, y, width, height);
        this._private_canvasTexture.needsUpdate = true;
        return this;
    }
    /**
     ...
     */
    circle(x, y, radius) {
        this._private_ctx.beginPath();
        this._private_ctx.arc(x, y, radius, 0, Math.PI * 2);
        this._private_ctx.closePath();
        this._private_canvasTexture.needsUpdate = true;
        return this;
    }
    /**
     ...
     */
    setFillStyle(style) {
        this._private_ctx.fillStyle = style instanceof UIColor ? style.toCSSColor() : style;
        return this;
    }
    /**
     ...
     */
    setLineWidth(width) {
        this._private_ctx.lineWidth = width;
        return this;
    }
    /**
    ...
    destroy() {
        this._private_colorInternal.off(UIColorEvent.CHANGE, this._private_onColorChange);
        this._private_canvasTexture.dispose();
        super.destroy();
    }
}
...
class UIImage extends UIElement {
    ...
    set texture(value) {
        ...
        this.sceneWrapper.setUniform(this.planeHandler, "uvTransform", value.matrix);
    }
    /**
     * Sets the color tint applied to the image.
     * @param value - The UIColor instance
...
var UIResizePolicyEvent;
(function (UIResizePolicyEvent) {
    UIResizePolicyEvent[UIResizePolicyEvent["CHANGE"] = 0] = "CHANGE";
})(UIResizePolicyEvent || (UIResizePolicyEvent = {}));
/**
 ...
 */
class UIResizePolicy extends i {
}
/**
 * No scaling applied, always returns 1:1 scale.
 */
class UIResizePolicyNone extends UIResizePolicy {
    calculateScaleInternal(width, height) {
        return 1;
    }
}
/**
 ...
 */
class UIResizePolicyFixedWidth extends UIResizePolicy {
    /**
     ...
     */
    constructor(fixedWidthLandscape, fixedWidthPortrait) {
        super();
        assertValidPositiveNumber(fixedWidthLandscape, "UIResizePolicyFixedWidth.fixedWidthLandscape");
        assertValidPositiveNumber(fixedWidthPortrait, "UIResizePolicyFixedWidth.fixedWidthPortrait");
        this._private_fixedWidthLandscapeInternal = fixedWidthLandscape;
        this._private_fixedWidthPortraitInternal = fixedWidthPortrait;
    }
    get fixedWidthLandscape() {
        return this._private_fixedWidthLandscapeInternal;
    }
    get fixedWidthPortrait() {
        return this._private_fixedWidthPortraitInternal;
    }
    set fixedWidthLandscape(value) {
        assertValidPositiveNumber(value, "UIResizePolicyFixedWidth.fixedWidthLandscape");
        if (value !== this._private_fixedWidthLandscapeInternal) {
            this._private_fixedWidthLandscapeInternal = value;
            this.emit(UIResizePolicyEvent.CHANGE);
        }
    }
    set fixedWidthPortrait(value) {
        assertValidPositiveNumber(value, "UIResizePolicyFixedWidth.fixedWidthPortrait");
        if (value !== this._private_fixedWidthPortraitInternal) {
            this._private_fixedWidthPortraitInternal = value;
            this.emit(UIResizePolicyEvent.CHANGE);
        }
    }
    calculateScaleInternal(width, height) {
        return width > height
            ? this._private_fixedWidthLandscapeInternal / width
            : this._private_fixedWidthPortraitInternal / width;
    }
}
/**
 ...
 */
class UIResizePolicyFixedHeight extends UIResizePolicy {
    /**
     ...
     */
    constructor(fixedHeightLandscape, fixedHeightPortrait) {
        super();
        assertValidPositiveNumber(fixedHeightLandscape, "UIResizePolicyFixedHeight.fixedHeightLandscape");
        assertValidPositiveNumber(fixedHeightPortrait, "UIResizePolicyFixedHeight.fixedHeightPortrait");
        this._private_fixedHeightLandscapeInternal = fixedHeightLandscape;
        this._private_fixedHeightPortraitInternal = fixedHeightPortrait;
    }
    get fixedHeightLandscape() {
        return this._private_fixedHeightLandscapeInternal;
    }
    get fixedHeightPortrait() {
        return this._private_fixedHeightPortraitInternal;
    }
    set fixedHeightLandscape(value) {
        assertValidPositiveNumber(value, "UIResizePolicyFixedHeight.fixedHeightLandscape");
        if (value !== this._private_fixedHeightLandscapeInternal) {
            this._private_fixedHeightLandscapeInternal = value;
            this.emit(UIResizePolicyEvent.CHANGE);
        }
    }
    set fixedHeightPortrait(value) {
        assertValidPositiveNumber(value, "UIResizePolicyFixedHeight.fixedHeightPortrait");
        if (value !== this._private_fixedHeightPortraitInternal) {
            this._private_fixedHeightPortraitInternal = value;
            this.emit(UIResizePolicyEvent.CHANGE);
        }
    }
    calculateScaleInternal(width, height) {
        return width > height
            ? this._private_fixedHeightLandscapeInternal / height
            : this._private_fixedHeightPortraitInternal / height;
    }
}
/**
 * Scales by width in landscape, by height in portrait.
 */
class UIResizePolicyCross extends UIResizePolicy {
    /**
     * @param fixedWidthLandscape - Target width for landscape
     * @param fixedHeightPortrait - Target height for portrait
     */
    constructor(fixedWidthLandscape, fixedHeightPortrait) {
        super();
        assertValidPositiveNumber(fixedWidthLandscape, "UIResizePolicyCross.fixedWidthLandscape");
        assertValidPositiveNumber(fixedHeightPortrait, "UIResizePolicyCross.fixedHeightPortrait");
        this._private_fixedWidthLandscapeInternal = fixedWidthLandscape;
        this._private_fixedHeightPortraitInternal = fixedHeightPortrait;
    }
    get fixedWidthLandscape() {
 ...
 */
class UIResizePolicyCrossInverted extends UIResizePolicy {
    /**
     * @param fixedHeightLandscape - Target height for landscape
     * @param fixedWidthPortrait - Target width for portrait
     */
    constructor(fixedHeightLandscape, fixedWidthPortrait) {
        super();
        assertValidPositiveNumber(fixedHeightLandscape, "UIResizePolicyCrossInverted.fixedHeightLandscape");
        assertValidPositiveNumber(fixedWidthPortrait, "UIResizePolicyCrossInverted.fixedWidthPortrait");
        this._private_fixedHeightLandscapeInternal = fixedHeightLandscape;
        this._private_fixedWidthPortraitInternal = fixedWidthPortrait;
    }
    get fixedHeightLandscape() {
...
class UIFullscreenLayer extends UILayer {
     ...
     */
    constructor(resizePolicy = new UIResizePolicyNone(), mode = UIMode.VISIBLE) {
        super(window.innerWidth, window.innerHeight);
        /**
         * Handles window resize. Updates layer dimensions according to resize policy.
         */
        this._private_onResize = () => {
            const scale = this._private_resizePolicyInternal.calculateScaleInternal(window.innerWidth, window.innerHeight);
        ...
        this.mode = mode;
        this._private_resizePolicyInternal = resizePolicy;
        this._private_resizePolicyInternal.on(UIResizePolicyEvent.CHANGE, this._private_onResize);
        this._private_onResize();
    }
    /**
     ...
     */
    get resizePolicy() {
        return this._private_resizePolicyInternal;
    }
    /**
     * Sets a new resize policy. Unsubscribes from old policy and subscribes to new one.
     */
    set resizePolicy(value) {
        if (this._private_resizePolicyInternal !== value) {
            this._private_resizePolicyInternal.off(UIResizePolicyEvent.CHANGE, this._private_onResize);
            this._private_resizePolicyInternal = value;
            this._private_resizePolicyInternal.on(UIResizePolicyEvent.CHANGE, this._private_onResize);
            this._private_onResize();
        }
    }
...
export { UIAnchor, UIAnimatedImage, UIAnimatedImageEvent, UIAspectConstraint, UIColor, UIColorEvent, UIConstraint, UIConstraint2DBuilder, UICoverConstraintBuilder, UICustomConstraint, UIDummy, UIElement, UIExpression, UIFitConstraintBuilder, UIFullscreenLayer, UIGenericInstancedPlane, UIGraphics, UIHeightConstraint, UIHorizontalDistanceConstraint, UIHorizontalProportionConstraint, UIImage, UIInputEvent, UILayer, UILayerEvent, UIMicro, UIMicroAnchorMode, UIMicroEvent, UIMode, UINineSlice, UIOrientation, UIPriority, UIProgress, UIProgressMaskFunction, UIRelation, UIResizePolicy, UIResizePolicyCross, UIResizePolicyCrossInverted, UIResizePolicyEvent, UIResizePolicyFixedHeight, UIResizePolicyFixedWidth, UIResizePolicyNone, UIScene, UISceneUpdateMode, UISingleParameterConstraint, UIText, UITransparencyMode, UIVerticalDistanceConstraint, UIVerticalProportionConstraint, UIWidthConstraint, convertPriority, convertRelation, isUITextSpan, isUITextStyle, resolveOrientation, resolvePriority, resolveRelation, resolveTextPadding, resolveTextStyle };
