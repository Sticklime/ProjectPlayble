...
export const bodyOwnerSymbol = Symbol("bodyOwnerSymbol");
const bodyUserDataSymbol = Symbol("bodyUserDataSymbol");
...
export class Body {
  ...
  public constructor(shape: AnyShape, options: AnyOptions, userData: any = {}) {
    ...
    (this.body as any)[bodyOwnerSymbol] = this;
    (this.body as any)[bodyUserDataSymbol] = userData;
  ...
  public get userData(): any {
    return (this.body as any)[bodyUserDataSymbol];
  }

  public set userData(value: any) {
    (this.body as any)[bodyUserDataSymbol] = value;
  }
}
