...
=======
>>>>>>> 2e5a9ab81664d2d2ea69d590036a67f27d490200
            Broadcast.on(
...
=======
                this.playSound("S_Background", { loop: true });
                // if (window.MraidSDK) MraidSDK.playSound("S_Background", { loop: true });
                // else this.playSound("S_Background", { loop: true });
>>>>>>> 2e5a9ab81664d2d2ea69d590036a67f27d490200
            }
    ...
    buildCamera() {
        ...
        this.cameraOperator.elevation = 90;
        this.cameraOperator.distance = 5;
    ...
    buildEnemies() {
        ...
        for (let i = 0; i < anchors.length; i++) {
            ...
            const materialRed = new THREE.MeshStandardMaterial({
                color: 0xfb1542,
                roughness: 0.25,      // Было 0.7 — стало меньше, материал более гладкий
                metalness: 0.7,       // Было 0.1 — стало больше, появляется глянец и отражения
                emissive: 0xfb1542,   // Яркое свечение того же цвета
                emissiveIntensity: 0.45, // Усиль свечение (0.3–0.6 по вкусу)
