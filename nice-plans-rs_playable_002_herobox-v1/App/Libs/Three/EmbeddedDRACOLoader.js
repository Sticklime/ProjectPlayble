import dracoCode from "three/addons/libs/draco/draco_decoder.js?raw";
import { DRACOLoader } from "three/addons/loaders/DRACOLoader.js";

export class EmbeddedDRACOLoader extends DRACOLoader {
  constructor() {
    super();
    ...
    this._initDecoder = () => {
      ...
      this.decoderPending = Promise.resolve().then(() => {
