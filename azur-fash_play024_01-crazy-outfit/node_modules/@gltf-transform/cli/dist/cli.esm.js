...
import { inspect as inspect$1, createTransform, listTextureSlots, getTextureChannelMask, fitWithin, fitPowerOfTwo, getTextureColorSpace, TextureResizeFilter, mergeDocuments, dedup, unpartition, INSTANCE_DEFAULTS, PALETTE_DEFAULTS, SIMPLIFY_DEFAULTS, JOIN_DEFAULTS, instance, palette, flatten, join as join$1, weld, simplify, resample, prune, sparse, textureCompress, draco, meshopt, quantize, partition, PRUNE_DEFAULTS, center, DRACO_DEFAULTS, MESHOPT_DEFAULTS, QUANTIZE_DEFAULTS, dequantize, unweld, tangents, UNWRAP_DEFAULTS, unwrap, reorder, metalRough, unlit, TEXTURE_COMPRESS_SUPPORTED_FORMATS, sequence } from '@gltf-transform/functions';
...
coordinates suitable for baking lightmaps or texture painting.
  ...
  options,
  logger
}) => Session.create(io, logger, args.input, args.output).transform(unwrap({
  watlas,
  ...options
})));
// REORDER
...
export { ETC1S_DEFAULTS, Filter, MICROMATCH_OPTIONS, Mode, TableFormat, UASTC_DEFAULTS, Validator, XMPContext, XMP_DEFAULTS, _waitExit, checkKTXSoftware, commandExists, dim, formatBytes, formatHeader, formatLong, formatParagraph, formatTable, formatXMP, ktxdecompress, ktxfix, merge, mockCommandExists, mockSpawn, mockWaitExit, program, programReady, regexFromArray, spawn, toktx, underline, waitExit, xmp };
